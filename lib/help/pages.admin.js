...
export const ADMIN_HELP_PAGES = {
  ...
  "/admin/dashboard": {
    ...
    body: "The landing page after login — this period's collection rate, outstanding dues, and the routes admins use most.",
    flow: ["Set the period", "Read the stats", "Click a stat to drill in", "Use Quick actions"],
    // app/admin/dashboard/PageClient.js
    steps: [
      "Set the month/year or financial-year picker in the header — every stat on the page updates together to match it.",
      "Click the Outstanding figure or any payment row to jump straight into Ledger, pre-filtered to that member.",
      "Use the “Quick actions” card for the 8 routes admins open most — the same 8 CommandBar's ⌘K / “n” shortcut lists.",
    ],
    checklist: [
      "Check the period picker before reading any number on this page — every stat is scoped to whatever period it's set to.",
    ],
